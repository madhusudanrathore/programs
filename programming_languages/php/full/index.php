...
<body onload="setTimeout(myFunction, 300000);">
<div class="wrapper">
    ...
    <h3>
      <?php 
      $q1="SELECT * FROM counter";
      $result1=$conn->query($q1);
      $data1=$result1->fetch_array();
      $old=$data1['users_visit'];
      echo $old;
    ...
    <tr>
      ...
      <td>
        ...
        <form action="controller.php" method="post">
          ...
          <input type="submit" onclick="return confirm('Are you sure you want to Delete  ?')" value="Delete" name="deleteUser">
        </form>
        <?php } ?>
      </td>
    </tr>
